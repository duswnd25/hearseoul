...
public class FetchSpotListTEst extends AsyncTask<Void,Integer,LinkedList<SpotBean>> {
    private FetchSpotListTEst.callback callback;
    private LatLng location;
    private int distance, max;

    public FetchSpotListTEst(LatLng location, int distance, int max, FetchSpotListTEst.callback callback) {
    ...
    @Override
    protected LinkedList<SpotBean> doInBackground(Void... voids) {
